...
# classifiers_max_balanced_multilabel_accuracy_score = np.max(classifiers_balanced_multilabel_accuracy_scores)
...
# difference_balanced_multilabel_accuracy_scores = np.array(combiners_balanced_multilabel_accuracy_scores) - classifiers_max_balanced_multilabel_accuracy_score
...
# bar2 = np.around(difference_balanced_multilabel_accuracy_scores, 3)
...
# difference_balanced_multilabel_accuracy_scores = (np.array(combiners_balanced_multilabel_accuracy_scores) -
#                                    classifiers_max_balanced_multilabel_accuracy_score).clip(min=0)
...
for i, perf in reversed(list(enumerate(difference_accuracies))):
    if difference_accuracies[i] == 0:
        ...
        # difference_balanced_multilabel_accuracy_scores = np.delete(difference_balanced_multilabel_accuracy_scores, i)
