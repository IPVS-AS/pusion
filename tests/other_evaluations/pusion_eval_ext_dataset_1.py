...
train_data = np.loadtxt("/int/datasets/aps/aps_failure_training_set_normalized.csv", delimiter=',', skiprows=21)
test_data = np.loadtxt("/int/datasets/aps/aps_failure_test_set_normalized.csv", delimiter=',', skiprows=21)

X_train = train_data[:, 1:]
a = train_data[:, 0]
# y_train = transform_label_vector_to_class_assignment_matrix(np.expand_dims(train_data[:, 0], axis=1), 2)
y_train = transform_label_vector_to_class_assignment_matrix(train_data[:, 0], 2)

X_test = test_data[:, 1:]
# y_test = transform_label_vector_to_class_assignment_matrix(np.expand_dims(test_data[:, 0], axis=1), 2)
y_test = transform_label_vector_to_class_assignment_matrix(test_data[:, 0], 2)
